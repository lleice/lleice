...
public class PropertiesUtils {
	...
	static {
		prop = new Properties();
		try {
			String _url = PropertiesUtils.class.getClassLoader().getResource( "generator.properties" ).getPath();
			prop.load(new FileInputStream(new File(_url)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static String getLayers(){
		...
		if(layers==null||"".equals(layers)){
			layers = "mapper,mapperxml,service,controller,entity,jsp";
		}
